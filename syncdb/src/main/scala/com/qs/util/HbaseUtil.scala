...
/**
 * @Date 2019/11/20
 * @Description hbase工具类：实现增删改查/建表
 */
object HbaseUtil {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //插入单列数据
    //    putDataByRowkey("test-1121","info","k1","11","003")
    //    //    //查询单列数据
    //    val str: String = queryByRowkey("test-1121","info","k1","003")
    //    println(str)
    //插入多列数据
    putMapDataByRowkey("test-1121","info",Map("k2"->"22","k3"->"33"),"002")

    //删除数据
    delByRowkey("test-1121","info","003")
